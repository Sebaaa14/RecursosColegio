...
public class Gestion {
	//Se crean las listas y mapas
	MapaCurso mapaCursos = new MapaCurso();
	ArrayListAlumno alumnos = new ArrayListAlumno();
	ColeccionProfesor profesores = new ColeccionProfesor();
	
	
	//Se cargan los archivos CSV correspondientes
	...
	//Metodo que corre todo el codigo al completo
			   ...
			   switch (opcion) {
				 ...
				 case 3:  
			   	...
			   	case 9 :
			   	   ...
			   	   profesores.obtenerProfesor(rut);
				   System.out.println(profesores.obtenerProfesor(rut));
				   break;
